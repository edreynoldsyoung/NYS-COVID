...
nys <-
     ...
     select(t = test_date,
            ...
            county) %>%
     filter(!county %in% c("Capital Region", "Central New York", "Finger Lakes", "Long Island", "Mid-Hudson", "Mohawk Valley", "New York City", "North Country", "Out-of-State", "STATEWIDE", "Southern Tier", "Western New York")) %>%
     mutate(
          t = as.Date(t),
          I = as.integer(I),
          C = as.integer(C),
