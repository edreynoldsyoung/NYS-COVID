...
check_load_pkgs <- function() {
     ...
     if (!require(colorspace)) {
          message("installing the 'colorspace' package")
...
ggplot(data = ny_map3) +
     ...
     scale_fill_stepsn(
          ...
          colours =  c(rgb(44,123,182, max = 255),
                   rgb(171,217,233, max = 255),
                   rgb(255,255,191, max = 255),
                   rgb(253,174,97, max = 255),
                   rgb(215,25,28, max = 255))) +
